...
var myChart = new Chart(ctx, {
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'China has recently surpassed Brazil in life expectancy',
                font: {
                    size: 18
                }
            },
            subtitle: {
                display: true,
                text: 'The United States has had the highest life expectancy of the top 5 most populous countries since 1800'
            }
        },
        scales: {
            y: {
